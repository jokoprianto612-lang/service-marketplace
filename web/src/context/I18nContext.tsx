...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'dashboard.experienceTitle': '3D Experience',
    'dashboard.experienceDesc': 'Interactive 3D visualizations powered by React Three Fiber. Explore services in a vibrant, living environment.',
  ...
  id: {
    ...
    'dashboard.experienceTitle': 'Pengalaman 3D',
    'dashboard.experienceDesc': 'Visualisasi 3D interaktif didukung oleh React Three Fiber. Jelajahi layanan di lingkungan yang hidup dan bersemangat.',
  ...
  zh: {
    ...
    'dashboard.experienceTitle': '3D 体验',
    'dashboard.experienceDesc': '由 React Three Fiber 提供支持的交互式 3D 可视化。在充满活力的生动环境中探索服务。',
